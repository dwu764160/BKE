...
if [[ $START_LAYER -le 2 ]]; then
    ...
    run_patched C5 src/data_compute/compute_rapm.py
    run_patched C6 src/data_compute/compute_xrapm.py
    run_patched C7 src/data_compute/compute_xrapm_improved.py
