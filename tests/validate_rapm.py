...
""")
    ...
    print("""
      ...
      1. REDUCE REGULARIZATION (Quick fix)
            - In src/modeling/model_rapm.py, try alphas = [50, 100, 250, 500, 1000]
...
def validate_xrapm_vs_benchmark(report):
    ...
    if xrapm_df is None:
        print("   ⚠️ No xRAPM data found. This pipeline now uses src/modeling/model_rapm.py and optional DARKO ingest.")
        return report
