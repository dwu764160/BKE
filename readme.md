...
Backtest validation: BKE carry r≈0.42-0.49, MPG carry r≈0.73-0.79 (scenario dependent); latest end-of-season forecast-style team-level win MAE/r after lineup-context calibration: `margin` ≈ 7.75-8.83 / 0.62-0.70, `ppp` ≈ 8.44-8.74 / 0.66-0.68
