...
python3 src/simulation/season_sim.py                        # Simulation Layer 4-5: Monte Carlo season simulation + aggregation (parallel margin + PPP models, shared lineup-context + archetype matchup adjustments, projected wins/playoff prob/confidence bands, detailed player season/game stats)
